odoo.define('l10n_cl_maintenance.form_widgets', function (require) {
    "use strict";
    ...
    ListRenderer.include({
        ...
        _updateSelection: function () {
            ...
            if (this.selection.length > 0) {
                $('.button_approve_otm_lines').show()
            } else {
                $('.button_approve_otm_lines').hide()
            }
    ...
    var One2ManySelectable = FieldOne2Many.extend({
        ...
        events: {
            "click .button_approve_otm_lines": "action_selected_lines",
        },
        start: function () {
        ...
        action_selected_lines: function () {
            ...
            rpc.query({
                'model': 'maintenance.request.master',
                'method': 'action_close_all_request2',
                'args': [selected_ids],
